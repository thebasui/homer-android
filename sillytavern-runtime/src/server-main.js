...
import homerBridgeMiddleware from './middleware/homerBridge.js';
import {
    getVersion,
    color,
...
import { router as homerRouter } from './endpoints/homer.js';
...
app.get('/version', async function (_, response) {
    if (getConfigValue('homerBridge.enabled', false, 'boolean')) {
        return response.send({
            agent: 'HomerDialogue:compatible',
